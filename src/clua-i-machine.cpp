...
static const auto machine_obj_index = cartesi::clua_make_luaL_Reg_array({
    ...
    {.name = "get_address_name", .func = machine_obj_index_get_address_name},
    {.name = "get_address_ranges", .func = machine_obj_index_get_address_ranges},
    {.name = "get_proof", .func = machine_obj_index_get_proof},
    {.name = "get_hash_tree_stats", .func = machine_obj_index_get_hash_tree_stats},
    {.name = "get_reg_address", .func = machine_obj_index_get_reg_address},
    {.name = "get_root_hash", .func = machine_obj_index_get_root_hash},
    {.name = "read_revert_root_hash", .func = machine_obj_index_read_revert_root_hash},
    {.name = "write_revert_root_hash", .func = machine_obj_index_write_revert_root_hash},
    {.name = "get_node_hash", .func = machine_obj_index_get_node_hash},
    {.name = "get_runtime_config", .func = machine_obj_index_get_runtime_config},
    {.name = "is_empty", .func = machine_obj_index_is_empty},
    {.name = "load", .func = machine_obj_index_load},
    {.name = "log_reset_uarch", .func = machine_obj_index_log_reset_uarch},
    ...
    {.name = "read_virtual_memory", .func = machine_obj_index_read_virtual_memory},
    {.name = "read_word", .func = machine_obj_index_read_word},
    {.name = "receive_cmio_request", .func = machine_obj_index_receive_cmio_request},
    {.name = "replace_memory_range", .func = machine_obj_index_replace_memory_range},
    {.name = "reset_uarch", .func = machine_obj_index_reset_uarch},
    {.name = "run", .func = machine_obj_index_run},
    {.name = "run_uarch", .func = machine_obj_index_run_uarch},
    {.name = "send_cmio_response", .func = machine_obj_index_send_cmio_response},
    ...
    {.name = "verify_reset_uarch", .func = machine_obj_index_verify_reset_uarch},
    ...
    {.name = "write_virtual_memory", .func = machine_obj_index_write_virtual_memory},
    {.name = "write_word", .func = machine_obj_index_write_word},
});
...
static const auto machine_meta = cartesi::clua_make_luaL_Reg_array({
    {.name = "__call", .func = machine_meta_call},
});
