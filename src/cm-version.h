...
#ifndef CARTESI_MACHINE_VERSION_H // NOLINTBEGIN
#define CARTESI_MACHINE_VERSION_H

#define CM_MARCHID 21

#define CM_VERSION_MAJOR 0
#define CM_VERSION_MINOR 21
#define CM_VERSION_PATCH 0
#define CM_VERSION_LABEL ""
#define CM_VERSION_NUM ((CM_VERSION_MAJOR * 1000000) + (CM_VERSION_MINOR * 1000) + CM_VERSION_PATCH)
